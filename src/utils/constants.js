import { FormTypes } from "../types/modalTypes";
...
export const regexp = {
  ...
  [FormTypes.NAME]: /^[A-Za-z]{3,16}$/,
  [FormTypes.SURNAME]: /^[A-Za-z]{3,16}$/,
  [FormTypes.PHONE]: /^[A-Za-z]{3,16}$/,
  [FormTypes.PASSPORT]: /^[A-Za-z]{3,16}$/,
};
